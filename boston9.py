...
st.title('Boston House Price App')
expander = st.beta_expander('About')
expander.markdown("""
* This app predicts the **Boston House Price**!
* Dataset: [Boston Data](https://www.kaggle.com/vikrishnan/boston-house-prices).
""")
...
#load pickle file
load_rfr = pickle.load(open('rfr_algo.pkl', 'rb'))

# RandomForestRegressor
pred = load_rfr.predict(df)


# Display
st.subheader('Values Selected')
st.write(df)
